...
const HeroSection = () => {
  return (
    <header className="flex items-center gap-2 min-h-[20vh] w-full px-6 md:px-10  mb-9 mt-4 flex-col">
      <LazyLoadImage loading="lazy" src={Bg} alt="BackgroundSection" className="relative rounded-xl h-[40vh] w-full" />
