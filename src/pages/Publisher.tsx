...
import { getDataByPublisher } from "../api/fetch";
...
const Publisher = () => {
  ...
  const { data, hasNextPage, fetchNextPage, isLoading, isFetching, isFetchingNextPage, isError, isSuccess } = useInfiniteQuery(["byPublisher", publisher], ({ pageParam = 1 }) => getDataByPublisher(pageParam, publisher), {
