...
import { getDataByGenre } from "../api/fetch";
...
const Genres = () => {
  ...
  const { data, hasNextPage, fetchNextPage, isLoading, isFetching, isFetchingNextPage, isError, isSuccess } = useInfiniteQuery(["byGenres", genre], ({ pageParam = 1 }) => getDataByGenre(pageParam, genre), {
